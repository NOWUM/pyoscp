...
RequiredBehaviour = Model(
    "RequiredBehaviour",
    {
        "heartbeat_interval": fields.Integer(
            description="Optional. The interval (in seconds) in which the sender of "
        ...
        "measurement_configuration": fields.List(
            fields.String(
                enum=measurement_configuration,
...
VersionUrl = Model(
    "VersionUrl",
    {
        ...
        "base_url": fields.Url(
            description="Mandatory. The base url for this version, e.g. https://oscp/cp/2.0."
        ),
    },
)
...
Handshake = Model("Handshake", {"required_behaviour": fields.Nested(RequiredBehaviour)})

HandshakeAcknowledgement = Model(
    "HandshakeAcknowledgement", {"required_behaviour": fields.Nested(RequiredBehaviour)}
)

Heartbeat = Model("Heartbeat", {"offline_mode_at": fields.DateTime()})

ForecastedBlock = Model(
    "ForecastedBlock",
    {
        ...
        "unit": fields.String(
            enum=forecasted_block_unit, description="Unit of the capacity value."
        ),
...
GroupCapacityForecast = Model(
    "GroupCapacityForecast",
    {
        ...
        "type": fields.String(
            enum=capacity_forecast_type, description="Identifies the type of forecast."
        ),
        "forecasted_blocks": fields.List(
            fields.Nested(ForecastedBlock),
...
GroupCapacityComplianceError = Model(
...
EnergyMeasurement = Model(
    "EnergyMeasurement",
    {
        ...
        "unit": fields.String(
            enum=energy_measurement_unit,
            description="Unit of this energy value (either Wh or kWh).",
        ),
        "energy_type": fields.String(
            enum=energy_type,
            description="Indicates whether flexible, non-flexible or total "
            "energy is reported. When absent, "
            "TOTAL is assumed.",
        ),
        "direction": fields.String(
            enum=energy_flow_direction,
            description="Indicates the direction the energy has flown into ("
            "import, export or net).",
        ),
        "measure_time": fields.DateTime(
            description="The moment the actual meter reading took place."
        ),
        "initial_measure_time": fields.DateTime(
            description="Optional. The moment the measurement has (re)started "
...
InstantaneousMeasurement = Model(
    "InstantaneousMeasurement",
    {
        ...
        "unit": fields.String(
            enum=instantaneous_measurement_unit, description="Unit of the value."
        ),
        "measure_time": fields.DateTime(
            description="The moment the actual meter reading took place."
        ),
...
AssetMeasurement = Model(
    "AssetMeasurement",
    {
        "asset_id": fields.String(
            description="Uniquely identifies the Flexibility Resource."
        ),
        "asset_category": fields.String(
            enum=asset_category,
            description="Defines the type of Flexibility Resource that is measured.",
        ),
        "energy_measurement": fields.Nested(
            EnergyMeasurement,
            description="Optional. Represents a read out of an accumulative energy meter.",
        ),
        "instantaneous_measurement": fields.Nested(
            InstantaneousMeasurement,
...
UpdateGroupMeasurements = Model(
    "UpdateGroupMeasurements",
    {
        "group_id": fields.String(
            description="The id of the area the Flexibility Resources (assets) are part of."
        ),
        "measurements": fields.List(
            fields.Nested(
                EnergyMeasurement, description="Contains the accumulated measurements."
            )
        ),
    },
)

UpdateAssetMeasurements = Model(
    "UpdateAssetMeasurements",
    {
        "group_id": fields.String(
            description="The id of the area which the Flexibility Resources (assets) are part of."
        ),
        "measurements": fields.List(
            fields.Nested(
                AssetMeasurement, description="Contains the accumulated measurements."
            )
        ),
    },
)
